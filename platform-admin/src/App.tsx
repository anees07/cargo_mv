...
function AuthGate({ error, onSignIn, onBootstrap }: { error: string | null; onSignIn: (email: string, password: string) => Promise<void>; onBootstrap?: () => Promise<void> }) {
