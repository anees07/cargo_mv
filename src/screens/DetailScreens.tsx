        ...
        <Card className="border-dashed p-3 text-xs text-slate-600">
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <p className="mt-0.5">The numbering sequence is locked per business profile. Multi-device conflicts are prevented by Firestore transaction-backed numbering.</p>
            </div>
          </div>
        </Card>
      </div>
